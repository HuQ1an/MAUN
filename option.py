...
parser.add_argument('--batch_size', type=int, default=20, help='the number of HSIs per batch')
...
parser.add_argument("--epoch_sam_num", type=int, default=5000, help='the number of samples per epoch') # 5000
